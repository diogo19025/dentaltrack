 ...
 * mensagem proativa que o operador envia para reengajar um paciente sobre uma
 * conversa anterior — sai pelo mesmo adaptador Evolution do canal WhatsApp e é
 * persistida na própria conversa. Escopado por clínica (o `clinicId` vem do
...
/** Corpo de POST /conversations/:id/reminder — o texto a enviar ao paciente. */
 ...
 * - `whatsapp_not_configured` — a clínica não conectou uma instância do WhatsApp.
 */
 ...
 * determinístico já pré-preenchido a partir do nome/interesse do paciente.
 */
