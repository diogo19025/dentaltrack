...
**11 de 12 concluídos.** Esta tabela é a fonte de verdade do progresso — se ela e a realidade divergirem, ela está errada.
...
| 10  | **Onboarding + demo** (P1.1, P1.2)                    | Checklist derivado, seed completo, `MockAgendaProvider` memoizado                                                                                                  | ✅ **2026-09-11**                                                            | —                                                   |
...
> - Contrato em `packages/shared/src/onboarding.ts`; serviço em `onboarding/onboarding-checklist.service.ts` (6 testes); web em `hooks/use-onboarding-checklist.ts` + `components/dashboard/onboarding-checklist.tsx` (3 testes).
...
## P1.2 · Ambiente de demonstração ✅ _PR 10 — entregue em 2026-09-11_
...
> - **A memoização do `MockAgendaProvider` fica por empresa _e fuso_** — o fuso é parâmetro do construtor, então trocá-lo recria a agenda. Instância viva enquanto o processo viver, como o `HolidaysService` já faz com o cache.
> - **Validado ao vivo em 2026-09-11** na clínica demo do Supabase: 90 conversas, 31 agendamentos nos seis status, fila com 4 pendentes/8 enviadas/2 falhas/2 suprimidas, 2 descadastros, 2 conversas em atendimento humano, 22 feriados, integração simulada com 7/8 status mapeados.
